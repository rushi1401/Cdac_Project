...
#for recorded video
sourc="C:/Users/User/Desktop/labtest/labt/No Light.mp4"
...
#out = cv2.VideoWriter('E:/Traffic Violation/TrafficviolationDetectionUsingOpenCV-main/op/1.mp4', fourcc, 20.0, (780, 640))  
...
if option=="M" or option=="m" :
    try:
        #while(cap.isOpened()):  #for live video-while camera is on
...
#      cascade_src="E:/Traffic Violation/TrafficviolationDetectionUsingOpenCV-main/CasCade FilrXML/cars3.xml"

#     car_cascade=cv2.CascadeClassifier(cascade_src)
#     while True:
#         ret, frm = cap.read()
#         frames = cv2.resize(frm, (780, 640),fx=0,fy=0,interpolation = cv2.INTER_NEAREST)
